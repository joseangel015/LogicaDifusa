...
while(True):
    ...
    for i in range(0,3,1):
        for k in range(0,numeroPixeles,1):
...
#Generación de la imagen a partir de la matriz de pertenencia U
